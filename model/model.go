...
type ActiveIngredient struct {
	...
	StockedUnits       decimal.Decimal `gorm:"type:numeric;default:0"`
...
type Medicine struct {
	...
	Dosage     decimal.Decimal `gorm:"type:numeric;default:0"`
	Package    string
	Form       string
...
type StockLog struct {
	...
	Units      decimal.Decimal `gorm:"type:numeric;default:0"`
}
